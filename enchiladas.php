...
<div class="row">
    ...
    <br/>
        ...
        <ul>
            <li class="testPage.php"><a href="#">Browse All</a></li>
...
if (!$conn) {
	...
	echo "<br>";
    $query = 'SELECT * from TestTable WHERE recipeName="Enchiladas"';
    ...
    if ($total_results > 0) {
        ...
        while($row = $results->fetch_assoc()) {
            echo "Recipe: " . $row["recipeName"]. ",  <br>Prep Time: " . $row["prepTime"]. " minutes<br>";
        }
    } else {
        echo "0 results";
    }
